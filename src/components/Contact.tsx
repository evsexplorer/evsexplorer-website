              ...
              <div className="text-center space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    {language === 'en' 
                      ? 'Get in touch with us to discuss your OCPP testing requirements and discover how EVSExplorer can enhance your workflow.'
                      : 'Setzen Sie sich mit uns in Verbindung, um Ihre OCPP-Testanforderungen zu besprechen und zu erfahren, wie EVSExplorer Ihren Workflow verbessern kann.'
                    }
                  </p>
                </div>
